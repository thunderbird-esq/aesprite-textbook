...
class AssetValidator:
    ...
    def __init__(self) -> None:
        ...
        """
        logger.info("Initializing AssetValidator with 1996 authenticity rules")
        ...
        # Color usage limits (70/20/10 rule)
        ...
        # Spine dead zone boundaries (pixels)
        ...
        # Safe zone margins (pixels from edge)
